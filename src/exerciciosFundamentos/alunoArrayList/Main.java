...
import exerciciosFundamentos.Pessoa;
import exerciciosFundamentos.Temperatura;
...
public class Main {
	...
	public static void main(String[] args) {
		...
		do {
			...
			case 4: removerPorPosicao(scan); break;
	...
	private static void removerPorPosicao(Scanner scan) {
		System.out.print("Posição: ");
		int posicao = scan.nextInt();
		ManipulaAlunos.remover(posicao);
	}
